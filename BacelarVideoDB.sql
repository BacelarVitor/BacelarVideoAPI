...
IF NOT EXISTS(SELECT * FROM sys.databases WHERE name = 'BacelarVideo')
  BEGIN
    CREATE DATABASE BacelarVideo
  END
...
INSERT INTO Cliente (Nome, Email, Senha, DataCriacao) Values ('Teste', 'teste@teste.com', 'teste', GETDATE())
INSERT INTO Cliente (Nome, Email, Senha, DataCriacao) Values ('Vitor', 'vitor@gmail.com', 'teste', GETDATE())
INSERT INTO Cliente (Nome, Email, Senha, DataCriacao) Values ('Gabriel', 'gabriel@gmail.com', 'teste', GETDATE())
